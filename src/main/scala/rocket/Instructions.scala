...
object Instructions {
  ...
  //yh+begin
  def TAGD               = BitPat("b?????????????????001?????1110111")
  def XTAG               = BitPat("b?????????????????010?????1110111")
  def CSTR         			 = BitPat("b?????????????????011?????1110111")
  def CCLR         			 = BitPat("b?????????????????101?????1110111")
  def CSRCH              = BitPat("b?????????????????000?????1110111")
  //yh+end
