...
object Instructions {
  ...
  ////yh+begin
  //def TAGC               = BitPat("b?????????????????001?????1110111")
  //def EACT               = BitPat("b?????????????????010?????1110111")
  //def EDEA         			 = BitPat("b?????????????????011?????1110111")
  //def ECHK         			 = BitPat("b?????????????????110?????1110111")
  //def ESTR               = BitPat("b?????????????????111?????1110111")
  //def ECLR               = BitPat("b?????????????????100?????1110111")
  ////yh+end
