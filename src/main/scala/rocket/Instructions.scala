...
object Instructions {
  ...
  //yh-def CUSTOM0            = BitPat("b?????????????????000?????0001011")
  //yh-def CUSTOM0_RS1        = BitPat("b?????????????????010?????0001011")
  //yh-def CUSTOM0_RS1_RS2    = BitPat("b?????????????????011?????0001011")
  //yh-def CUSTOM0_RD         = BitPat("b?????????????????100?????0001011")
  //yh-def CUSTOM0_RD_RS1     = BitPat("b?????????????????110?????0001011")
  //yh-def CUSTOM0_RD_RS1_RS2 = BitPat("b?????????????????111?????0001011")
  //yh-def CUSTOM1            = BitPat("b?????????????????000?????0101011")
  //yh-def CUSTOM1_RS1        = BitPat("b?????????????????010?????0101011")
  //yh-def CUSTOM1_RS1_RS2    = BitPat("b?????????????????011?????0101011")
  //yh-def CUSTOM1_RD         = BitPat("b?????????????????100?????0101011")
  //yh-def CUSTOM1_RD_RS1     = BitPat("b?????????????????110?????0101011")
  //yh-def CUSTOM1_RD_RS1_RS2 = BitPat("b?????????????????111?????0101011")
  //yh+begin
	// PA primitives
  def TAGD               = BitPat("b?????????????????001?????0001011")
  def AUTD               = BitPat("b?????????????????011?????0001011")
  def XTAG               = BitPat("b?????????????????100?????0001011")
	// DPT primitives
  def CSTR         			 = BitPat("b?????????????????011?????0101011")
  def CCLR         			 = BitPat("b?????????????????111?????0101011")
  //yh+end
  ...
  //yh-def CUSTOM3            = BitPat("b?????????????????000?????1111011")
  //yh-def CUSTOM3_RS1        = BitPat("b?????????????????010?????1111011")
  //yh-def CUSTOM3_RS1_RS2    = BitPat("b?????????????????011?????1111011")
  //yh-def CUSTOM3_RD         = BitPat("b?????????????????100?????1111011")
  //yh-def CUSTOM3_RD_RS1     = BitPat("b?????????????????110?????1111011")
  //yh-def CUSTOM3_RD_RS1_RS2 = BitPat("b?????????????????111?????1111011")
  //yh+begin
	// Bit Manipulation primitives
  def BSETM              = BitPat("b?????????????????000?????1111011")
  def BCLRM              = BitPat("b?????????????????001?????1111011")
  def BEXTM              = BitPat("b?????????????????010?????1111011")
	//yh+end
...
object Causes {
  ...
  //yh+begin
	val ldchk_fault = 0x18
	val stchk_fault = 0x19
	val cstr_fault = 0x1a
	val cclr_fault = 0x1b
  //yh+end
  val all = {
