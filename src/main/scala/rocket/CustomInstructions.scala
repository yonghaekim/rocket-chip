...
object CustomInstructions {
  ...
  //yh+begin
  def TAGC               = BitPat("b?????????????????001?????1111011")
  def EACT               = BitPat("b?????????????????010?????1111011")
  def EDEA         			 = BitPat("b?????????????????011?????1111011")
  def ECHK         			 = BitPat("b?????????????????110?????1111011")
  def ESTR               = BitPat("b?????????????????111?????1111011")
  def ECLR               = BitPat("b?????????????????100?????1111011")
  //yh+end
}
